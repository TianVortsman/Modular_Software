...
-- Unified Clients table replacing customers and company
...
-- Address and Contact Types (unchanged)
...
-- Contact Person table (unchanged)
...
-- Client Addresses (replace customer_address and company_address)
...
-- Client Contacts (replace customer_contact and company_contact)
...
CREATE TABLE invoicing.documents (
    ...
    related_document_id INTEGER REFERENCES invoicing.documents(document_id), -- for credits/refunds/etc.
